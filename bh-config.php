...
define('FIRST_PHONE_START_GREETING',20025412);
define('FIRST_PHONE_END_GREETING',20025422);
define('SECOND_PHONE_START_GREETING',20025412);
define('SECOND_PHONE_END_GREETING',20025422);
define('THIRD_PHONE_START_GREETING',20025412);
define('THIRD_PHONE_END_GREETING',20025422);
